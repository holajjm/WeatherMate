...
function PreviewMbti() {
  ...
  useEffect(() => {
    ...
    tl.from('.fade-in-from-SE',{opacity: 0, y: 200, duration: 5});
    return () => {
      tl.kill();
    }
  },[])
  ...
  return (
    <div className="p-4 rounded-2xl shadow-[0px_4px_10px_rgba(0,0,0,0.2),inset_0px_4px_10px_rgba(255,255,255,0.5)] shadow-violet-300 h-full fade-in-from-SE">
